...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/private/var/www/SIPRealty/app/cache/prod/annotations', false);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/private/var/www/SIPRealty/app/cache/prod/assetic/config'), false)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber($this->get('simplethings_entityaudit.log_revisions_listener'));
        ...
        $d->addEventSubscriber($this->get('simplethings_entityaudit.create_schema_listener'));
        ...
        $d->addEventListener(array(0 => 'loadClassMetadata', 1 => 'postGenerateSchema', 2 => 'postPersist', 3 => 'postFlush'), $this->get('sip.translation.listener'));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'audio_guide', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $d, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/private/var/www/SIPRealty/app/cache/prod/jms_diextra/doctrine/EntityManager_537e4d61864a0.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_3488ba2f8688f58850cba3fa93d51427');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_3488ba2f8688f58850cba3fa93d51427');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_3488ba2f8688f58850cba3fa93d51427');
        ...
        $f->setProxyDir('/private/var/www/SIPRealty/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager537e4d61864a0_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($g, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/private/var/www/SIPRealty/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    protected function getJmsSerializerService()
    {
        ...
        $a->setCache(new \Metadata\Cache\FileCache('/private/var/www/SIPRealty/app/cache/prod/jms_serializer'));
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/private/var/www/SIPRealty/app/logs/prod.log', 100, true);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $f->setCacheDir('/private/var/www/SIPRealty/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/private/var/www/SIPRealty/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/private/var/www/SIPRealty/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/private/var/www/SIPRealty/app/cache/prod/sessions');
    }
    ...
    protected function getSonata_EasyExtends_Doctrine_MapperService()
    {
        ...
        $instance->addAssociation('Armd\\ResourceBundle\\Entity\\User\\User', 'mapManyToMany', array(0 => array('fieldName' => 'groups', 'targetEntity' => 'Armd\\ResourceBundle\\Entity\\User\\Group', 'cascade' => array(), 'joinTable' => array('name' => 'fos_user_user_group', 'joinColumns' => array(0 => array('name' => 'user_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'inverseJoinColumns' => array(0 => array('name' => 'group_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')))), 1 => array('fieldName' => 'groups', 'targetEntity' => 'Armd\\ResourceBundle\\Entity\\User\\Group', 'cascade' => array(), 'joinTable' => array('name' => 'fos_user_user_group', 'joinColumns' => array(0 => array('name' => 'user_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE')), 'inverseJoinColumns' => array(0 => array('name' => 'group_id', 'referencedColumnName' => 'id', 'onDelete' => 'CASCADE'))))));
        $instance->addAssociation('Armd\\ResourceBundle\\Entity\\Media\\Media', 'mapOneToMany', array(0 => array('fieldName' => 'galleryHasMedias', 'targetEntity' => 'Armd\\ResourceBundle\\Entity\\Media\\GalleryHasMedia', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'media', 'orphanRemoval' => false), 1 => array('fieldName' => 'galleryHasMedias', 'targetEntity' => 'Armd\\ResourceBundle\\Entity\\Media\\GalleryHasMedia', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'media', 'orphanRemoval' => false)));
        $instance->addAssociation('Armd\\ResourceBundle\\Entity\\Media\\GalleryHasMedia', 'mapManyToOne', array(0 => array('fieldName' => 'gallery', 'targetEntity' => 'Armd\\ResourceBundle\\Entity\\Media\\Gallery', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'galleryHasMedias', 'joinColumns' => array(0 => array('name' => 'gallery_id', 'referencedColumnName' => 'id')), 'orphanRemoval' => false), 1 => array('fieldName' => 'media', 'targetEntity' => 'Armd\\ResourceBundle\\Entity\\Media\\Media', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'galleryHasMedias', 'joinColumns' => array(0 => array('name' => 'media_id', 'referencedColumnName' => 'id')), 'orphanRemoval' => false), 2 => array('fieldName' => 'gallery', 'targetEntity' => 'Armd\\ResourceBundle\\Entity\\Media\\Gallery', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'galleryHasMedias', 'joinColumns' => array(0 => array('name' => 'gallery_id', 'referencedColumnName' => 'id')), 'orphanRemoval' => false), 3 => array('fieldName' => 'media', 'targetEntity' => 'Armd\\ResourceBundle\\Entity\\Media\\Media', 'cascade' => array(0 => 'persist'), 'mappedBy' => NULL, 'inversedBy' => 'galleryHasMedias', 'joinColumns' => array(0 => array('name' => 'media_id', 'referencedColumnName' => 'id')), 'orphanRemoval' => false)));
        $instance->addAssociation('Armd\\ResourceBundle\\Entity\\Media\\Gallery', 'mapOneToMany', array(0 => array('fieldName' => 'galleryHasMedias', 'targetEntity' => 'Armd\\ResourceBundle\\Entity\\Media\\GalleryHasMedia', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'gallery', 'orphanRemoval' => true, 'orderBy' => array('position' => 'ASC')), 1 => array('fieldName' => 'galleryHasMedias', 'targetEntity' => 'Armd\\ResourceBundle\\Entity\\Media\\GalleryHasMedia', 'cascade' => array(0 => 'persist'), 'mappedBy' => 'gallery', 'orphanRemoval' => true, 'orderBy' => array('position' => 'ASC'))));
        return $instance;
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/private/var/www/SIPRealty/app/cache/prod/translations', 'debug' => false));
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/private/var/www/SIPRealty/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/private/var/www/SIPRealty/app/../web', false);
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/private/var/www/SIPRealty/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/private/var/www/SIPRealty/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/private/var/www/SIPRealty/app/cache/prod',
            ...
            'session.save_path' => '/private/var/www/SIPRealty/app/cache/prod/sessions',
            ...
            'router.resource' => '/private/var/www/SIPRealty/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/private/var/www/SIPRealty/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'assetic.cache_dir' => '/private/var/www/SIPRealty/app/cache/prod/assetic',
            ...
            'swiftmailer.spool.default.memory.path' => '/private/var/www/SIPRealty/app/cache/prod/swiftmailer/spool/default',
            ...
            'doctrine.orm.proxy_dir' => '/private/var/www/SIPRealty/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/private/var/www/SIPRealty/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/private/var/www/SIPRealty/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/private/var/www/SIPRealty/app/cache/prod/jms_diextra/doctrine/EntityManager_537e4d61864a0.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager537e4d61864a0_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/private/var/www/SIPRealty/app/cache/prod/jms_security',
            ...
            'fos_rest.cache_dir' => '/private/var/www/SIPRealty/app/cache/prod/fos_rest',
