...
class __TwigTemplate_56c70f96c702636c1784718d89b9f0056c10918df2f242b3fdef83b2e11ae475 extends Twig_Template
{
...
<div class=\"sonata-user-edit-profile\">
    ...
    <form action=\"";
        ...
        echo "
            <div class=\"controls\">";
        // line 44
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "dateOfBirth"), 'widget', array("attr" => array("class" => "span1")));
        echo "</div>
        </div>
        <div class=\"control-group\">
            ";
