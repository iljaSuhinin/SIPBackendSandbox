...
class __TwigTemplate_6fd69f145b2edec5df2ae3b24a91ca58a0b5a0c03ecdd56480f2c752713365fa extends Twig_Template
{
    ...
    public function block_block($context, array $blocks = array())
    {
        // line 14
        echo "    ";
        if ($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "format")) {
            // line 15
            echo "        ";
        ...
        <div class=\"sonata-media-block-gallery-container\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["element"]) {
                // line 23
                echo "                        <li data-type=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["element"]) ? $context["element"] : null), "type"), "html", null, true);
                echo "\" data-title=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["element"]) ? $context["element"] : null), "title"), "html", null, true);
                echo "\" data-caption=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["element"]) ? $context["element"] : null), "caption"), "html", null, true);
                echo "\">
                            ";
                // line 24
                if (($this->getAttribute((isset($context["element"]) ? $context["element"] : null), "type") == "image")) {
                    // line 25
                    echo "                                ";
                    echo $this->env->getExtension('sonata_media')->media($this->getAttribute((isset($context["element"]) ? $context["element"] : null), "media"), $this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "format"), array());
                    // line 26
                    echo "                            ";
                } elseif (($this->getAttribute((isset($context["element"]) ? $context["element"] : null), "type") == "video")) {
                    // line 27
                    echo "                                ";
                    echo $this->env->getExtension('sonata_media')->media($this->getAttribute((isset($context["element"]) ? $context["element"] : null), "media"), $this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "format"), array());
                    // line 28
        ...
        <script type=\"text/javascript\">
            ...
            echo "').nivoGallery({
                     pauseTime:     ";
            // line 40
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "pauseTime"), "html", null, true);
            echo ",
                     animSpeed:     ";
            // line 41
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "animSpeed"), "html", null, true);
            echo ",
                     effect:        'fade',
                     startPaused:   ";
            // line 43
            if (($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "startPaused") == 1)) {
                echo "true";
            } else {
                echo "false";
            }
            echo ",
                     directionNav:  ";
            // line 44
            if (($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "directionNav") == 1)) {
                echo "true";
            } else {
                echo "false";
            }
            echo ",
                     progressBar:   ";
            // line 45
            if (($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "progressBar") == 1)) {
                echo "true";
            } else {
                echo "false";
            }
